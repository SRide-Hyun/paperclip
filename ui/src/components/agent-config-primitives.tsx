...
export const help: Record<string, string> = {
  ...
  fastMode: "Enable Codex Fast mode. This burns credits/tokens much faster and is supported on GPT-6 Astra and Sol, GPT-5.6, GPT-5.5, GPT-5.4, and manual Codex model IDs.",
