...
auth_kind: ("oauth" | "api_key" | "none")
change_source: ("api" | "gallery" | "oauth_callback" | "credential_refresh" | "archive" | "example" | "composio_sync")
connector_key: string
enabled: boolean
...
export const PAPERCLIP_ENUM_DESCRIPTIONS = {
  ...
  "connection.updated": {
    ...
    "change_source": {
      ...
      "gallery": "An app-gallery setup step changed the persisted lifecycle state.",
